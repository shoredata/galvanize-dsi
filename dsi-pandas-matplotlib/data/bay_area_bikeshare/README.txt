Changes between available data and original data:  

- The rebalancing file has been removed.  Because of its large size, working with it takes a long time.
- The column names have been cleaned up with the make_snake_case.py program. The original column names had some casing inconsistencies, and they included spaces which remove some options for how you reference them in pandas.

        ------------------------- Original README below -------------------------
FILE LIST
1) 201408_rebalancing_data.csv – approx. 18 million records of rebalancing data (bike and dock availability)
