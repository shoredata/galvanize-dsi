...
def invert_dictionary(d1):
    ...
    for k, v in d1.items():
        ...
        keys.append(k)
    return inv #these are being returned out of order, unsure how to re-order
...
def cookie_jar(a, b):
    ...
    #         -------------
    #         p(a)
    # P(A) = P(jar_a) = 0.5 and P(B) = P(jar_b) = 0.5
    # P(chocolate|A) = inpa
    # P(chocolate|B) = inpb
